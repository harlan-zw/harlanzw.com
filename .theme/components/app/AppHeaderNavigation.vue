...
const hasNavigation = computed(() => !!scribe.value.aside?.level)

const filtered = computed(() => scribe.value.header?.exclude || [])
  ...
  <nav v-if="hasNavigation">
    <ul>
      ...
      >
        ...
        >
          <Icon v-if="link.icon && scribe.header.showLinkIcon" :name="link.icon" />
          {{ link.title }}
        </NuxtLink>
      </li>
    </ul>
