...
A [Nuxt]{class="text-red-600"} :i-heroicons-outline-beaker{class="text-indigo-700"} to build a Markdown driven website, based on [Nuxt Content](https://content.nuxtjs.org), [TailwindCSS](https://tailwindcss.com) and [Iconify](https://iconify.design) :sparkles:
