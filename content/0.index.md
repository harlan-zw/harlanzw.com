...
[:icon{name="logos:nuxt-icon" class="mx-1" alt="Nuxt icon"} Nuxt](https://nuxtjs.org/){title="Open Nuxtjs.org"} <sup class="opacity-80 italic">insiders</sup> ◦ [:icon{name="logos:vueuse" class="mx-1" alt="VueUse icon"} VueUse](https://vueuse.org){title="Open VueUse.org"} ◦ [:windi-icon{alt="WindiCSS icon"} WindiCSS](https://windicss.com){title="Open windicss.com"}
