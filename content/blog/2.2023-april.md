...
:prose-img{src="/april-mangrove.png" alt="Saw a monkey in the mangroves while kayaking" no-margin}
:prose-img{src="/april-koa-sok.png" alt="The jungles of Khao Sok" no-margin}
:prose-img{src="/april-phi-phi.png" alt="Ko Phi Phi" no-margin}
:prose-img{src="/april-pi.png" alt="In the Pai hole" no-margin}
::
::
...
:prose-img{src="/april-numbers.png" alt="My WakaTime numbers for April"}

:prose-img{src="/april-fathom.png" alt="My April Fathom Traffic"}
