...
<ProseImg src="/august-mosque-1" alt="Fatih Mosque, İstanbul"  no-margin />
<ProseImg src="/august-mosque-2" alt="The Blue Mosque, İstanbul"  no-margin />
</div>
</Expand>
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-kebab" alt="Kebab, Lahmacun, Pide"  no-margin />
<ProseImg src="/august-sweets" alt="İstanbul sweet shop"  no-margin />
</div>
</Expand>
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-rock-formation" alt="Well-endowed rock formations, Gorkundere Valley"  no-margin />
<ProseImg src="/august-goreme" alt="Sunset at Göreme"  no-margin />
</div>
</Expand>
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-hike.png" alt="Start of the Rose Valley hike"  no-margin />
<ProseImg src="/august-cave-outside.png" alt="One of the many abandoned cave dwellings"  no-margin />
<ProseImg src="/august-hike-rope.png" alt="Rope climb featuring a friendly dog"  no-margin />
<ProseImg src="/august-cave-church-2.png" alt="Walking around inside an abandoned Cave Church"  no-margin />
</div>
</Expand>
...
<ProseImg src="/august-balloons" alt="Göreme Sunrise Balloons"  no-margin />
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-sofia-2" alt="Government of Bulgaria, Sofia" no-margin />
<ProseImg src="/august-sofia-3.png" label="St. Alexander Nevsky Cathedral, Sofia"  no-margin />
</div>
</Expand>
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-rila-lake-start.png" alt="Start of the Seven Rila Lake hike"  no-margin />
<ProseImg src="/august-rila-lake-2.png" label="About half way up" label="Seven Rila Lake Hike"  no-margin />
<ProseImg src="/august-rila-lake-3.png" label="One of the 7 lakes" alt="One of the lakes of the Sven Rila Lake Hike"  no-margin />
</div>
</Expand>
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-rila-lake.png" label="Some nice waterfalls near the top" alt="Seven Rila Lake Hike Waterfall"  no-margin />
<ProseImg src="/august-rila-lake-fog.png" label="A bit too foggy at the peak" alt="Seven Rila Lake Hike Top Very Foggy"  no-margin />
</div>
</Expand>
...
<ProseImg src="/august-skopje" alt="Archaeological Museum, Skopje" />

A nice day trip from Skopje is Matka Canyon, you can do some nice hiking, lake swims and kayaking.

<ProseImg src="/august-canyon-hike" alt="Matka Canyon Hike" />
...
<ProseImg src="/august-ohrid" label="Quintessential shot of Lake Ohrid" />
...
<ProseImg src="/august-girokaster.png" label="Sunset Gjirokastër, Albania" />
...
<ProseImg src="/august-blue-eye.png" label="Blue Eye Lake, Albania" />
...
<ProseImg src="/august-himare.png" label="Himarë sunset" />
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-theth.png" label="The view from where we were staying" alt="Theth Mountains"  no-margin />
<ProseImg src="/august-theth-2.png"  label="Another view from where we were staying" label="church" alt="Theth Mountains"  no-margin />
<ProseImg src="/august-theth-3.png" label="Mountainside from a hike"  alt="Theth Mountains"  no-margin />
<ProseImg src="/august-theth-4.png" label="One more - I really liked them!"  alt="Theth Mountains"  no-margin />
</div>
</Expand>
...
<Expand>
<div class="grid grid-cols-2 gap-5 my-15">
<ProseImg src="/august-theth-mountain-cow.png" label="A mountain cow towards the peak!" alt="Cow in Theth Mountains"  no-margin />
<ProseImg src="/august-theth-mountain-2.png" label="View from the peak, it was really foggy."  no-margin />
</div>
</Expand>
